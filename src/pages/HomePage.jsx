    ...
    <>
      <main>
        <section className="hero">
          <div className="hero-content"><span className="eyebrow hero-eyebrow">Wholesale, thoughtfully sourced</span><h1>Stocked for<br /><em>Singapore.</em></h1><p>From sesame and soyabean supply to dependable service for growing food businesses, we help brands and retailers stay ready for demand.</p><a className="button button-dark" href="#categories">Explore our range <span>↓</span></a></div>
        ...
        <section className="statement-section" id="about"><span className="section-number">01 / 04</span><div><span className="eyebrow">More than a supplier</span><h2>Built for<br /><em>Singapore trade.</em></h2></div><p>Kalki Business is a Singapore-based wholesale partner delivering dependable product quality, useful conversations and steady supply for businesses that need confidence every day.</p></section>

        <section className="categories-section" id="categories"><div className="section-heading"><div><span className="eyebrow">The range</span><h2>Find your <em>fit.</em></h2></div><span className="section-number">02 / 04</span></div><div className="category-grid">{categories.map((category, index) => <CategoryCard category={category} index={index} key={category.slug} />)}</div><div className="category-foot"><span>Sesame &amp; soyabean supply</span><span>Tap a category to explore <span aria-hidden="true">↗</span></span></div></section>
